...
api_key='cg9Na8j3gUIGoTqwfE9rIBT9KUkaR4GnAZQuMqpq'
...
def generate():
	if request.method == 'POST':
		...
		gen = prediction.generations[0].text
	return render_template('generate.html',gen = gen)
